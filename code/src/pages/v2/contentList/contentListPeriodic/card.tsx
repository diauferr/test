  ...
  return (
    <div>
      {text.length > 50 ? (
        ...
        <CardTextShowed style={{ height: '57.2px', fontWeight: 'bold' }}>
          {text}
        </CardTextShowed>
      )}
    </div>
  ...
  return (
    <div>
      {text.length > 50 ? (
        ...
        <CardTextShowed style={{ height: '57.2px' }}>{text}</CardTextShowed>
      )}
    </div>
  );
};
  ...
  return (
    <Container
      ...
      style={{
        ...
        boxShadow: hover ? '0px 4px 12px -4px rgba(0,0,0,0.15)' : 'none',
        MozBoxShadow: hover ? '0px 4px 12px -4px rgba(0,0,0,0.15)' : 'none',
        WebkitBoxShadow: hover ? '0px 4px 12px -4px rgba(0,0,0,0.15)' : 'none',
